...
digitMap = M.fromList [(S.fromList "abcefg" , 0),
                         (S.fromList "cf"     , 1),
                         (S.fromList "acdeg"  , 2),
                         (S.fromList "acdfg"  , 3),
                         (S.fromList "bcdf"   , 4),
...
uniqueMap = M.fromList [(2, S.fromList "cf"),
                        (3, S.fromList "acf"),
                        (4, S.fromList "bcdf")]

entry :: Entry
entry = (["acedgfb", "cdfbe", "gcdfa", "fbcad" ,"dab",
          "cefabd", "cdfgeb", "eafb" ,"cagedb" , "ab"], ["cdfeb", "fcadb", "cdfeb", "cdbaf"])
